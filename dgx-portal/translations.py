...
FR_TO_EN = {
    ...
    "Qui utilise le modèle": "Who is using the model",
    "· 2 dernières min · visible admin uniquement": "· last 2 min · admin only",
    "Personne n'utilise le modèle en ce moment.": "Nobody is using the model right now.",
