...
FR_TO_EN = {
    ...
    "compte": "account",
    "les tokens du prompt comptent 10× moins": "prompt tokens count 10× less",
    ...
    "Unité = 1 token généré par le modèle ; les tokens envoyés dans le prompt comptent pour 1/10e.":
        "Unit = 1 token generated by the model; prompt tokens count as 1/10.",
    ...
    "Tokens consommés": "Tokens consumed",
