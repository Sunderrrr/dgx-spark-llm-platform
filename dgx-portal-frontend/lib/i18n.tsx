...
const EN: Record<string, string> = {
  ...
  "Montant (tokens)": "Amount (tokens)",
  "Autre montant...": "Other amount...",
  "Durée du supplément": "Boost duration",
  "Permanente": "Permanent",
  "1 j": "1 d",
  "3 j": "3 d",
  "7 j": "7 d",
  "30 j": "30 d",
  "Nouveau total : {total} — retour à {base} le {date} UTC.": "New total: {total} — back to {base} on {date} UTC.",
  "Lien de partage copié (lecture seule, réservé aux connectés).": "Share link copied (read-only, signed-in users only).",
  "Copiez le lien de partage :": "Copy the share link:",
  "Partage impossible : le serveur n'a pas répondu.": "Sharing failed: the server did not respond.",
  "Redéfinir le plafond d'un compte": "Reset an account's cap",
  "Montant exact (pas un ajout) — sert aussi à baisser un quota. La fenêtre de reset reste celle du portail.": "Exact amount (not an addition) — also lowers a quota. The reset window stays the portal's global one.",
  "Choisir un compte": "Pick an account",
  "Plafond actuel :": "Current cap:",
  "illimité": "unlimited",
  "Rechercher...": "Search...",
  "Actuel :": "Current:" ,
  "Nouveau plafond (tokens)": "New cap (tokens)",
  "Redéfinir": "Set",
  "Budget redéfini.": "Budget updated.",
  "jours": "days",
  "Continuer": "Continue",
  ...
  "Composition annulée.": "Composition cancelled.",
  "Impossible d'annuler.": "Could not cancel.",
  "Journal d'audit": "Audit log",
  "Acteur": "Actor",
  "Détail": "Detail",
  "Aucune entrée": "No entries",
  "Les actions sensibles apparaîtront ici.": "Sensitive actions will appear here.",
  "Exporter": "Export",
  "Partager": "Share",
  "Lien copié": "Link copied",
  "Exporter JSON": "Export JSON",
  "Recherche rapide": "Quick search",
  "Commence à taper pour chercher": "Start typing to search",
  "Aucun résultat": "No results",
  "Navigation": "Navigation",
  "Renommer": "Rename",
  "Valider": "Confirm",
  "Usage par modèle": "Usage by model",
  "Tokens consommés ces dernières 24 h, par modèle (tous comptes).": "Tokens used over the last 24 h, by model (all accounts).",
  "Voir": "View",
  ...
  "La fenêtre de contexte = entrée (system prompt + messages + fichiers) + sortie (réponse générée). Le % indique la part utilisée.": "The context window = input (system prompt + messages + files) + output (the generated reply). The % shows how much is used.",
  ...
  "Trouve la cause d'une erreur dans des logs": "Find the cause of an error in logs",
  "Rédige un texte, un email ou un document": "Write a text, email or document",
  "Traduis un texte vers une autre langue": "Translate a text to another language",
  "Propose des idées et des alternatives": "Propose ideas and alternatives",
  "Relis, corrige et améliore un texte": "Review, correct and improve a text",
  "Résume ce texte en 3 points clairs et concis : ": "Summarize this text in 3 clear, concise points: ",
  "Explique-moi ce sujet simplement, comme à un débutant : ": "Explain this topic simply, as if to a beginner: ",
  "Écris le code suivant, complet et exécutable : ": "Write the following code, complete and runnable: ",
  "Rédige le texte suivant : ": "Write the following text: ",
  "Traduis le texte suivant : ": "Translate the following text: ",
  "Propose-moi des idées à partir de ce sujet : ": "Give me ideas about this topic: ",
  ...
  "Messages": "Messages",
  "Message en cours de modification": "Editing a message",
  "Le prochain envoi remplacera ce message et la suite de la conversation.": "The next send will replace this message and the rest of the conversation.",
  "En modification": "Editing",
  ...
  "Musique": "Music",
  "Nombre de versions": "Number of versions",
  "Composer {n} versions": "Compose {n} versions",
  "Version": "Version",
  "versions": "versions",
  "Version {d} sur {n} — tu peux quitter la page, la composition continue.": "Version {d} of {n} — you can leave the page, composing continues.",
